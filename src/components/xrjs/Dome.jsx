...
export default function Dome({ photoIndex, setPhotoIndex, mediaPath, mediaDb, pauseRef, muteRef }) {
  ...
  useEffect(() => {
    ...
    pauseRef?.current.addEventListener('click', handler);
    return () => pauseRef.current.removeEventListener('click', handler);
  ...
  useEffect(() => {
    ...
    muteRef?.current.addEventListener('click', handler);
    return () => muteRef.current.removeEventListener('click', handler);
